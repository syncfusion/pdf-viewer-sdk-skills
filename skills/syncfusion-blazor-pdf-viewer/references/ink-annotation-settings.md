# Ink Settings in Blazor SfPdfViewer Component
...
Ink settings allow you to configure default appearance, behavior, and restrictions for Ink annotations in the PDF Viewer. Use these settings to control properties of the Ink annotation.
...
```razor
<SfPdfViewer2>
    <PdfViewerInkAnnotationSettings AllowedInteractions="allowedInteractions" AnnotationSelectorSettings="selectorSettings" Author="selectorSettings" BorderDashArray="[1, 3]" CustomData="CustomData" FillColor="green" Height="150" IsLock="true" IsPrint="false" MaxHeight="100" MaxWidth="100" MinHeight="50" MinWidth="50" Opacity="0.5" SkipDownload="false" SkipPrint="false" StrokeColor="yellow" Thickness="3" Width="150"></PdfViewerInkAnnotationSettings>
</SfPdfViewer2>
