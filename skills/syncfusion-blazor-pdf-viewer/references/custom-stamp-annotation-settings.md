# Custom Stamp Settings in Blazor SfPdfViewer Component
...
Custom Stamp settings allow you to configure default appearance, behavior, and restrictions for custom stamp / Image annotations in the PDF Viewer. Use these settings to control properties of the custom stamp / Image annotation.
...
| **CustomStamps** | Gets or sets a collection of custom stamps for the PDF Viewer. | List<[PdfViewerCustomStamp](./annotation-enum-properties.md#pdfviewercustomstamp)> |
| **EnableCustomStamp** | If it is set as false, then we can't add the custom stamp annoation in the PDF Viewer. By default it is true. | bool |
| **IsAddToMenu** | Specifies to maintain the newly added custom stamp element in the menu items. By default it is false | bool |
...
```razor
<SfPdfViewer2>
    <PdfViewerCustomStampSettings AllowedInteractions="allowedInteractions" AnnotationSelectorSettings="selectorSettings" Author="Syncfusion" BorderDashArray="[1, 3]" CustomData="CustomData" CustomStamps="customStamps" EnableCustomStamp="true" FillColor="green" Height="150" IsAddToMenu="true" IsLock="true" IsPrint="false" MaxHeight="100" MaxWidth="100" MinHeight="50" MinWidth="50" Opacity="0.5" SkipDownload="false" SkipPrint="false" StrokeColor="yellow" Thickness="3" Width="150"></PdfViewerCustomStampSettings>
</SfPdfViewer2>
...
@code {
    ...
    List<PdfViewerCustomStamp> customStamps = new List<PdfViewerCustomStamp>() {
