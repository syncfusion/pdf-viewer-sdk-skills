# Distance Settings in Blazor SfPdfViewer Component
...
Distance settings allow you to configure default appearance, behavior, and restrictions for distance annotations in the PDF Viewer. Use these settings to control properties of the distance annotation.
...
| **LineHeadEndStyle** | Defines the head end style of the annotation. | [LineHeadStyle](./annotation-general-enum-properties.md#lineheadstyle) |
| **LineHeadStartStyle** | Defines the head end style of the annotation. | [LineHeadStyle](./annotation-general-enum-properties.md#lineheadstyle) |
| **LeaderLength** | Defines the leader length of the annotation. By default it is 40. | double |
...
```razor
<SfPdfViewer2>
    <PdfViewerDistanceSettings AllowedInteractions="allowedInteractions" AnnotationSelectorSettings="selectorSettings" Author="Syncfusion" BorderDashArray="[1, 3]" CustomData="CustomData" FillColor="green" IsLock="true" IsPrint="false" LeaderLength="30" LineHeadEndStyle="LineHeadStyle.Diamond" LineHeadStartStyle="LineHeadStyle.Diamond" MaxHeight="100" MaxWidth="100" MinHeight="50" MinWidth="50" Opacity="0.5" SkipDownload="false" SkipPrint="false" StrokeColor="yellow" Thickness="3"></PdfViewerDistanceSettings>
</SfPdfViewer2>
