...
```cshtml
@Html.EJS().PdfViewer("pdfviewer").FreeTextSettings.(new Syncfusion.EJ2.PdfViewer.PdfViewerFreeTextSettings {FillColor="green", BorderColor="blue", FontColor="yellow", FontSize=14, FontFamily="Arial"}).Render()
```