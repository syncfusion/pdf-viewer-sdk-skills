...
<div style="width:100%;height:600px">
    <ejs-pdfviewer id="pdfviewer"
                   ...
                   documentPath="https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf"
                   enableMagnification="true"
                   zoomMode="@Syncfusion.EJ2.PdfViewer.ZoomMode.FitToPage">
    </ejs-pdfviewer>
</div>
```
...
<ejs-pdfviewer id="pdfviewer"
               documentPath="https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf"
               zoomMode="@Syncfusion.EJ2.PdfViewer.ZoomMode.FitToWidth"
               enableMagnification="true">
</ejs-pdfviewer>
```
...
<div style="width:100%;height:600px">
    <ejs-pdfviewer id="pdfviewer"
                   style="height:600px"
                   documentPath="https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf"
                   zoomMode="@Syncfusion.EJ2.PdfViewer.ZoomMode.Default">
    </ejs-pdfviewer>
</div>
```
