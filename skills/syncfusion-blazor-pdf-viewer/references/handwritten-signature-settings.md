# Handwritten Signature Settings in Blazor SfPdfViewer Component
...
Handwritten Signature settings allow you to configure default appearance, behavior, and restrictions for Handwritten Signature annotations in the PDF Viewer. Use these settings to control properties of the Handwritten Signature annotation.
...
| **SignatureDialogSettings** | Specified the signature dialog settings. | [PdfViewerSignatureDialogSettings](./annotation-enum-properties.md#pdfviewersignaturedialogsettings) |
...
```razor
<SfPdfViewer2>
    <PdfViewerHandwrittenSignatureSettings AllowedInteractions="allowedInteractions" AnnotationSelectorSettings="selectorSettings" Author="Syncfusion" BorderDashArray="[1, 3]" CustomData="CustomData" FillColor="green" Height="150" IsLock="true" IsPrint="false" MaxHeight="100" MaxWidth="100" MinHeight="50" MinWidth="50" Opacity="0.5" SignatureDialogSettings="signatureDialogSettings" SkipDownload="false" SkipPrint="false" StrokeColor="yellow" Thickness="3" Width="150"></PdfViewerHandwrittenSignatureSettings>
</SfPdfViewer2>
...
@code {
    ...
    PdfViewerSignatureDialogSettings signatureDialogSettings = new PdfViewerSignatureDialogSettings() {
        DisplayMode = DisplayMode.Text,
        HideSaveSignature = true,
        SignatureFonts = FontFamilies
    };
    internal static string[] FontFamilies { get; set; } = { "Helvetica", "Courier", "Symbol", "Times New Roman", "Arial Black", "Courier New", "Arial" };
}
```
