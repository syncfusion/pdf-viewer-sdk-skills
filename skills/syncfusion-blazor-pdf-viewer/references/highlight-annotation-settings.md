# Highlight Settings in Blazor SfPdfViewer Component
...
Highlight settings allow you to configure default appearance, behavior, and restrictions for Highlight annotations in the PDF Viewer. Use these settings to control properties of the Highlight annotation.
...
```razor
<SfPdfViewer2>
    <PdfViewerHighlightSettings AllowedInteractions="allowedInteractions" Author="Syncfusion" CustomData="CustomData" Color="green" EnableMultiPageAnnotation="false" EnableTextMarkupResizer="true" IsLock="true" IsPrint="false" MaxHeight="100" MaxWidth="100" MinHeight="50" MinWidth="50" Opacity="0.5" SkipDownload="false" SkipPrint="false"></PdfViewerHighlightSettings>
</SfPdfViewer2>
