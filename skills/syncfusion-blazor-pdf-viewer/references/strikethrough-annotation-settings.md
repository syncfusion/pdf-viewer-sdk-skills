# Strikethrough Settings in Blazor SfPdfViewer Component
...
Strikethrough settings allow you to configure default appearance, behavior, and restrictions for Strikethrough annotations in the PDF Viewer. Use these settings to control properties of the Strikethrough annotation.
...
```razor
<SfPdfViewer2>
    <PdfViewerStrikethroughSettings AllowedInteractions="allowedInteractions" Author="Syncfusion" Color="green" CustomData="CustomData" EnableMultiPageAnnotation="false" EnableTextMarkupResizer="true" IsLock="true" IsPrint="false" MaxHeight="100" MaxWidth="100" MinHeight="50" MinWidth="50" Opacity="0.5" SkipDownload="false" SkipPrint="false"></PdfViewerStrikethroughSettings>
</SfPdfViewer2>
