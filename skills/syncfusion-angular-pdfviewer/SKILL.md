---
name: syncfusion-angular-pdfviewer
...
compatibility: Starting from Angular 19, standalone components are the default. Moreover in Angular 19 and below, it uses app.component.ts, app.component.html, app.component.css etc. In Angular 20+, the CLI generates a simpler structure with src/app/app.ts, app.html, and app.css (no .component. suffixes).
metadata:
...
2. Use read_file on: d:\Mar2nd-Sprint\v5\.codestudio\skills\syncfusion-angular-pdfviewer\references\[filename].md
