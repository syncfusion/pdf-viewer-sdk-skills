...
The **syncfusion-react-pdf-viewer** skill enables AI-assisted code generation for the [Syncfusion React PDF Viewer (`PdfViewerComponent`)](https://www.syncfusion.com/pdf-viewer-sdk/react-pdf-viewer). It produces minimal, copy-pasteable TSX/JSX code to embed, configure, and interact with PDF documents inside React applications.
