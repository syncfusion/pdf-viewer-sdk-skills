# Annotation Settings in ASP.NET Core PDF Viewer Component
...
```html
@{
  var highlightSettings = new Syncfusion.EJ2.PdfViewer.PdfViewerHighlightSettings 
  { 
    Color = "green", 
    Opacity = 0.6 
  };
...
```html
@{
  var annotationSelectorSettings = new Syncfusion.EJ2.PdfViewer.PdfViewerAnnotationSelectorSettings 
  { 
...
```html
@{
  var areaSettings = new Syncfusion.EJ2.PdfViewer.PdfViewerAreaSettings 
  { 
    AnnotationSelectorSettings = new Syncfusion.EJ2.PdfViewer.PdfViewerAnnotationSelectorSettings 
    { 
      ResizerBorderColor = "green" 
    } 
  };
