# General Properties in React SfPdfViewer Component
...
| **initialRenderPages** | Set the number of pages to render initially for performance. | `number` | `3` | `InteractionMode` | `TextSelection` |
...
| **serviceUrl** | Set the service URL for server-side operations. | `string` | `"https://services.syncfusion.com/react/api/pdfviewer"` |
