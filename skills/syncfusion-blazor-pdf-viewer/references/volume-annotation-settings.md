# Volume Settings in Blazor SfPdfViewer Component
...
Volume settings allow you to configure default appearance, behavior, and restrictions for Volume annotations in the PDF Viewer. Use these settings to control properties of the Volume annotation.
...
```razor
<SfPdfViewer2>
    <PdfViewerVolumeSettings AllowedInteractions="allowedInteractions" AnnotationSelectorSettings="selectorSettings" Author="Syncfusion" BorderDashArray="[1, 3]" CustomData="CustomData" FillColor="green" IsLock="true" IsPrint="false" MaxHeight="100" MaxWidth="100" MinHeight="50" MinWidth="50" Opacity="0.5" SkipDownload="false" SkipPrint="false" StrokeColor="yellow" Thickness="3"></PdfViewerVolumeSettings>
</SfPdfViewer2>
