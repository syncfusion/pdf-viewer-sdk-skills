# Line Settings in Blazor SfPdfViewer Component
...
Line settings allow you to configure default appearance, behavior, and restrictions for Line annotations in the PDF Viewer. Use these settings to control properties of the Line annotation.
